...
Давайте попробуем перейти от неё к рекуррентному нейрону по аналогии с линейной моделью. На картинке рекуррентный нейрон можно изобразить следующим образом:
...
Из-за того, что скрытое состояние теперь зависит от времени, одним уравнением ограничиться не получится. Нам надо на каждом шаге обновлять его, а затем строить прогноз. 
