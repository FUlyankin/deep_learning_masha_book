...
__а)__  Маша выделяет окно длины $100$. Оно движется по последовательности. Для каждого окна Маша предсказывает следующее значение в ряду. В сетку подаются наблюдения с $1$-го по $100$-е. Прогнозируется $101$-е наблюдение. Затем на вход подаются наблюдения со $2-$го по $100$-е. Прогнозируется $102$-е наблюдение. И так далее до конца последовательности.
...
__г)__ Мы находимся в условиях прошлого пункта, но используем LSTM-ячейки с забыванием. Сколько параметров надо оценить? 

```{dropdown} Решение
Решение будет позже
```
    
__д)__ Мы находимся в условиях прошлого пункта, но используем GRU-ячейки. Сколько параметров надо оценить?
