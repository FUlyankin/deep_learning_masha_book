...
__а)__ В ящике стола Маша нашла персептрон с картинки {ref}`perseptron01`.  Маша хочет подобрать веса так, чтобы он реализовывал логическое отрицание, то есть превращал $x_1 = 0$ в $y=1$, а $x_1 = 1$ в $y=0$. 
...
__б)__ В тумбочке, среди носков, Маша нашла персептрон с картинки {ref}`perseptron02`. Маша хочет подобрать такие веса $w_i$, чтобы персептрон превращал $x_1, x_2, x_3$ из таблички ниже в соответствующие $y$:
