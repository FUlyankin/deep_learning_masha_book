...
\begin{equation*}
	...
	& w_2 =  0.31 + \frac{0.1}{\sqrt{10.41}} \cdot 9.47 = 0.61
	\end{aligned}
\end{equation*}
...
\begin{equation*}
    \begin{aligned}
        & g_2 = \nabla_w L(w_0) = -4(3 - w_1 \cdot 2) = -11.2 \\
        & h_2 = \frac{0.9 \cdot (-4) + 0.1 \cdot (-11.2)}{0.19} = -24.84 \\
        & v_2 = \frac{0.9 \cdot (-4)^2 + 0.1 \cdot (-11.2)^2}{0.19} = 141.81 \\
        & w_2 = 0.1 + \frac{0.1}{\sqrt{141.81}} \cdot 24.84 = 0.3
    \end{aligned}
\end{equation*}
```
