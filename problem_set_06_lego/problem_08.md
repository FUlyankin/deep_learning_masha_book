...
Получается, что $\text{Var}(h_1) = \frac{k}{4} + s = \sigma^2.$ Отсюда получаем, что параметр $b$ надо инициализировать как 
...
$$
f_Y(y) = \begin{cases} \frac{1}{a}, y \in [0; a] \\ 0, \text{ иначе}. \end{cases}
$$
