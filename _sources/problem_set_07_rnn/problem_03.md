...
::::{important}
Тут будет упражнение про взрыв/затухание градиентов в рекуррентных архитектурах и способы лечить его. От LSTM до инициализации ортогональными матрицами с неумирающими активациями.
::::
