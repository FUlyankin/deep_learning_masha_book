...
```{dropdown} Решение
Мы уже нашли выше производную. У гиперболического тангенса нет обучаемых параметров, получается, прямой проход через него делается по формуле
...
__д)__ Как у тангенса дела с центрированием относительно нуля? 
