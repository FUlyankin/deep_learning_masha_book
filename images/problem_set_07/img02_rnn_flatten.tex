...
\begin{document}
		\begin{tikzpicture}
				...
				\draw node at (0, -2) [place, fill=green, opacity=0.1] (x) {$y_{t-2}$};
				...
				\draw node at (2, -2) [place, fill=green, opacity=0.1] (x1) {$y_{t-1}$};
				...
				\draw node at (4, -2) [place, fill=green, opacity=0.1] (x2) {$y_{t}$};
