...
\begin{tikzpicture}
    ...
    \addplot[domain=-5:5, red, ultra thick,samples=500]{x*1/(1+exp(-x))};
    \addlegendentry{$\beta = 1$};

    \addplot[domain=-5:5, blue, ultra thick,samples=500]{x*1/(1+exp(-10*x))};
    \addlegendentry{$\beta = 10$};

    \addplot[domain=-5:5, magenta, ultra thick,samples=500]{x*1/(1+exp(-0.1*x))};
