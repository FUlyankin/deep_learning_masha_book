...
\begin{minipage}{0.25\linewidth} 
    ...
    \begin{tikzpicture}[scale=.5,every node/.style={minimum size=1cm}, on grid]
            ...
            \draw[draw=green,thick] (-1,-3) grid (6,4);
            \draw[fill=cyan,opacity=0.4] (-1,1) rectangle (2,4);
            
            \node (-1-1) at (-0.5,3.5) {0};
            \node (0-1) at (0.5,3.5) {0};
            \node (1-1) at (1.5,3.5) {0};
            \node (2-1) at (2.5,3.5) {0};
            \node (3-1) at (3.5,3.5) {0};
            \node (4-1) at (4.5,3.5) {0};
            \node (5-1) at (5.5,3.5) {0};
            \node (06) at (-0.5,-2.5) {0};
            \node (16) at (0.5,-2.5) {0};
            \node (26) at (1.5,-2.5) {0};
            \node (36) at (2.5,-2.5) {0};
...
\begin{minipage}{0.25\linewidth} 
    ...
    \begin{tikzpicture}[scale=.5,every node/.style={minimum size=1cm}, on grid]
            \draw[fill=green,opacity=0.4] (0,-2) rectangle (5,3);
            \draw[draw=green,thick] (-1,-3) grid (6,4);
            \draw[fill=cyan,opacity=0.4] (0,1) rectangle (3,4);
