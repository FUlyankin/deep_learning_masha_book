...
\begin{document}
    \begin{tikzpicture}[scale=1]
        ...
        \draw [->]  (first_2) to node[above]{$w_{12}$} (second_1);
        \draw [->]  (first_2) to node[below]{$w_{11}$} (second_2);
        % \draw [->]  (first_2) to node[below]{} (second_3);
        % \draw [->]  (first_2) to node[below]{} (second_4);

        \draw [->]  (first_3) to node[above]{$w_{13}$} (second_1);
        \draw [->]  (first_3) to node[above]{$w_{12}$} (second_2);
        % \draw [->]  (first_3) to node[below]{} (second_3);
        % \draw [->]  (first_3) to node[below]{} (second_4);
        
        % \draw [->]  (first_4) to node[below]{} (second_1);
        \draw [->]  (first_4) to node[below]{$w_{13}$} (second_2);
        % \draw [->]  (first_4) to node[below]{} (second_3);
        % \draw [->]  (first_4) to node[below]{} (second_4);
        
        \draw [->]  (first_5) to node[above]{$w_{21}$} (second_1);
        % \draw [->]  (first_5) to node[below]{} (second_2);
        \draw [->]  (first_5) to node[above]{$w_{11}$} (second_3);
